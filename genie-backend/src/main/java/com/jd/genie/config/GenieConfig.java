...
public class GenieConfig {
    ...
    @Value("${autobots.autoagent.tool.knowledge_rag_tool.desc:}")
    private String knowledgeRAGToolDesc;

    /**
     * knowledgeRAGTool 配置
     */
    private Map<String, Object> knowledgeRAGToolParams = new HashMap<>();
    @Value("${autobots.autoagent.tool.knowledge_rag.params:{}}")
    public void setKnowledgeRAGToolParams(String jsonStr) {
        this.knowledgeRAGToolParams = JSON.parseObject(jsonStr, Map.class);
    }

    @Value("${autobots.autoagent.knowledge_rag_url:http://localhost:1601}")
