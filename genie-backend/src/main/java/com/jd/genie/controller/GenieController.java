    ...
    private ToolCollection buildToolCollection(AgentContext agentContext, AgentRequest request) {
        ...
        if ("dataAgent".equals(request.getOutputStyle())) {
            ...
            if (!agentToolList.isEmpty()) {
                ...
                if (agentToolList.contains("knowledge_rag")) {
                    KnowledgeRAGTool knowledgeRAGTool = new KnowledgeRAGTool();
                    knowledgeRAGTool.setAgentContext(agentContext);
                    toolCollection.addTool(knowledgeRAGTool);
                }
            }
        }
